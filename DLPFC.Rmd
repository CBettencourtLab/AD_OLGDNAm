...
M_matrix_DLPFC <- as.matrix(t(M_matrix_DLPFC_t))
...
fit = lmFit(M_matrix_DLPFC, design_DLPFC)
...
mAdj_DLPFC        <- as.matrix(M_matrix_DLPFC) - mAdj.fit_DLPFC %*% t(design_DLPFC[,-c(1:2)])
